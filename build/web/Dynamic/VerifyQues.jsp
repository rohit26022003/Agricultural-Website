...
<html>
    ...
    <body style="background-color: antiquewhite">
        ...
        <%
            ...
            if(request.getParameter("bVerify")!=null)
            {
                ...
                <script>
                    ...
                    location.href="http://localhost:8080/AgriEvolution/Html/NewPassword.jsp?pemail=<%=vemail%>";
                </script>
                <%
                }
                else
        ...
        <form name="frmSecurity" method="POST" action="http://localhost:8080/AgriEvolution/Html/VerifyQues.jsp?pemail=<%=vemail%>">
        <div>
            <table border="1">
                <thead>
