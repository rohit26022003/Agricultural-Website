<%-- 
    Document   : Customer
    Created on : 27 Nov, 2024, 12:07:43 PM
    Author     : ramkr
--%>
          ...
          <table id="recent-orders--table">
            ...
            <tbody id="tbd">
                <%
                   ...
                   while(ors.next()){
                       int id = ors.getInt("USER_ID");
                       String name = ors.getString("USER_NAME"); 
                       String pm = ors.getString("USER_MAIL");
                       String st = ors.getString("PHONE");
                %> 
                          <tr>
                           <td><%= id %></td>
                          <td><%= name %></td>
