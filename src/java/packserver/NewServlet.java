...
//            oconn = (OracleConnection)DriverManager.getConnection("jdbc:oracle:thin:@ARINDELL:1521:ORCL","SRIJONI","CHATTERJEE");
//           ost =(OraclePreparedStatement) oconn.prepareStatement("SELECT * FROM STUDENTS where email=?");
            ...
            if(ors.next()) 
            {
                ...
                final String username ="sectionk705@gmail.com";
                final String password = "lhdzxwnttyurrgbl";
            ...
            try {
                    ...
                    vbody += "\n http://localhost:8080/TestWeb/Generators/VerifyQues.jsp?pemail="+vemail;
                    message.setText(vbody);
                    Transport.send(message);
                    response.sendRedirect("http://localhost:8080/TestWeb/Pages/StudentClose.html");
